...
//	static final public String[] elencoComandi = {"vai","aiuto","fine","prendi","posa"};

	private Partita partita;
	private IO io;		//dichiarazione di ioconsole
	private FabbricaDiComandi fabbricaComandi;

	public DiaDia(IO io) {
		this.partita = new Partita();
		this.io = io;		//inizializzo l'istanza di ioconsole a quella che gli viene passata dal costruttore
	}
...
//		Scanner scannerDiLinee;		//rimuovo lo scanner perchè ora farà tutto ioConsole
		...
		io.mostraMessaggio(MESSAGGIO_BENVENUTO);		//stampa il messaggio tramite ioConsole.mostraMessaggio
//		scannerDiLinee = new Scanner(System.in);		
		do		
			istruzione = io.leggiRiga();				//leggi input tramite ioConsole.leggiRiga
...
//
	public static void main(String[] argc) {
		IO io = new IOConsole();		//creo un'istanza di ioconsole
		DiaDia gioco = new DiaDia(io);		//passo l'istanza di ioconsole al costruttore di diadia
		gioco.gioca();
	}
}