...
public class Stanza {
	...
	//funzione getter per poter usare la variabile privata NUMERO_MASSIMO_DIREZIONI nella classe StanzaTest
	...
	*/
	public boolean hasAttrezzo(String nomeAttrezzo) {
		...
		trovato = false;
		for (Attrezzo attrezzo : this.attrezzi) {
			if (attrezzo!=null && attrezzo.getNome().equals(nomeAttrezzo))		//ho aggiunto la condizione attrezzo!=null così da evitare che attrezzo.getNome venga invocato nel caso in cui non ci sia alcun attrezzo collegato
				trovato = true;
		}
		return trovato;
	}
